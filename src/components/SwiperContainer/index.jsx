...
export function Swiper(props) {
  ...
  return (
    <Container>
      ...
      <button className={String(indexLeftArrow)} style={ {display: numberElements != 0 ? "block" : "none"}}>
      ...
      <button className={String(indexRightArrow)} style={ {display: numberElements != 0 ? "block" : "none"}}>
        <svg width="16" height="28" viewBox="0 0 16 28" fill="none" xmlns="http://www.w3.org/2000/svg">
